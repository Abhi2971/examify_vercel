...
const L1_MENU_ITEMS = [
  { label: 'Dashboard', icon: LayoutDashboard, path: '/support/l1/dashboard' },
  { label: 'My Tickets', icon: MessageSquare, path: '/support/l1/tickets' },
  { label: 'Knowledge Base', icon: BookOpen, path: '/support/l1/knowledge-base' },
  { label: 'Help & Resources', icon: HelpCircle, path: '/support/l1/help-resources' },
  { label: 'Profile & Settings', icon: Settings, path: '/support/l1/settings' }
]

export function L1SupportLayout() {
        ...
        <div className="h-full m-3 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 flex flex-col">
          ...
          <div className="p-4 border-b border-white/10">
            <div className={`flex items-center gap-3 ${collapsed && 'justify-center'}`}>
              <div className={`w-10 h-10 rounded-full bg-gradient-to-br from-[#00C4B4] to-[#00E5FF] flex items-center justify-center flex-shrink-0`}>
